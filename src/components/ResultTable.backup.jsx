  ...
  return (
    <section id="print-area" className="print-area bg-paper rounded-2xl p-5 shadow-soft border border-subtle">
      ...
      <div className="text-center mb-3">
        <div className="text-2xl font-arabic">بِسْمِ اللّٰهِ الرَّحْمٰنِ الرَّحِيمِ</div>
      ...
      <div className="grid grid-cols-2 gap-3 text-sm">
        ...
        <div className="rounded-xl p-3 border border-subtle bg-white/70">
          <div className="text-primary/80">Vasiyet/Borç İndirimi</div>
      ...
      <div className="mt-5 grid gap-3">
        ...
        <div className="flex items-start gap-3 rounded-xl border border-red-300 bg-red-50 p-3">
          ...
          <p className="text-sm text-red-800">
            <strong>Uyarı:</strong> Allah’ın Kitabı'nda belirlenen bu paylar, O’nun sınırlarıdır. Bu sınırları kim aşarsa kendine yazık etmiş olur.
          </p>
        </div>
      </div>
    </section>
